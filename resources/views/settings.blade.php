            ...
            <div class="row mt-10">
                <div class="col-lg-8 mb-30">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="company-staff-form" method="post" action="{{ url('update-settings') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="company_name"><span class="red">*</span> Title</label>
                                            <input type="text" name="title" class="form-control" required value="{{ $settings->title }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div class="card-body">
                            <form action="{{ url('updateEmailSettings') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-email-setting="host" class="form-control @error('host') is-invalid @enderror" placeholder="Email Email Host" name="host" value="{{ $data['host'] }}" required>
                                    @error('host')
